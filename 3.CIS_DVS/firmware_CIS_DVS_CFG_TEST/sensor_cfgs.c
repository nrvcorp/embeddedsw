...
struct regval_list DVS_regs[] = {
	...
	{0x3915, 0x24}, // [5:4] mipi_ck_mode, [3] : use_line, [2] : use_frm, [1] : use_2_lane, [0] : use_1_lane
					...
					//		{0x3915, 0x26}, // mipi 2lane�뜝�럥�맶�뜝�럥吏쀥뜝�럩援꿨뜝�럥�맶�뜝�럥吏쀥뜝�럩援� �뜝�럥�맶�뜝�럥吏쀥뜝�럩援꿨뜝�럥�맶�뜝�럥吏쀥뜝�럩援�
					//		{0x3915, 0x25}, // mipi 1lane�뜝�럥�맶�뜝�럥吏쀥뜝�럩援꿨뜝�럥�맶�뜝�럥吏쀥뜝�럩援� �뜝�럥�맶�뜝�럥吏쀥뜝�럩援꿨뜝�럥�맶�뜝�럥吏쀥뜝�럩援�
	...
	{0x0167, 0x07}, // REG_DIV_BCM_BOT_UNIT_ON // 높을수록 on 이벤트에 민감
	{0x0168, 0x0f}, // REG_DIV_BCM_BOT_UNIT_nOFF // 낮을수록 off 이벤트에 민감
...
struct regval_list DVS_regs_modified[] = {
    {0x3225, 0x12},
    {0x0166, 0x31},
    {0x300c, 0x00}, // STREAM_OUT_MODE_r(0 : MIPI, 1 : PARALLEL)
    {0x30a1, 0x00}, // [0] : OUTIF_PARA_ENABLE
    ...
    {0x30a3, 0x1f}, // DPHY_ENABLE
    {0x30a5, 0x00}, // DPHY_PLL_PMS
    {0x30a6, 0x67}, // DPHY_PLL_PMS
    {0x30a7, 0xD1}, // DPHY_PLL_PMS
    {0x303b, 0x40}, // TEST PAD_CONTROL
    ...
    {0x3915, 0x24}, // [5:4] mipi_ck_mode, [3] : use_line, [2] : use_frm, [1] : use_2_lane, [0] : use_1_lane
                    //        {0x3915, 0x04}, // clock disabled between packets
                    //        {0x3915, 0x26}, // mipi 2lane 占쎌맶 �뙴占� 占쎄뎡 占쎌맶 �뙴占� 占쎄뎡  占쎌맶 �뙴占� 占쎄뎡 占쎌맶 �뙴占� 占쎄뎡
                    //        {0x3915, 0x25}, // mipi 1lane 占쎌맶 �뙴占� 占쎄뎡 占쎌맶 �뙴占� 占쎄뎡  占쎌맶 �뙴占� 占쎄뎡 占쎌맶 �뙴占� 占쎄뎡

    {0x3901, 0x2a},
    {0x3902, 0x00}, // csi2_pkt_size_low			// internal buffer size
    {0x3903, 0x20}, // csi2_pkt_size_high			// 0x2000 : 8kb mipi pkt buffer
    {0x3908, 0x00}, // /DPHY ULPS disable(0x00) enable(0x01)
    {0x391A, 0x7F}, // frm_cnt_low
    {0x391B, 0x00}, // frm_cnt_high
    {0x3910, 0x81}, // [7] : use_timeout, [0] : use_big_endian
    {0x3911, 0x7C}, // to_scnt0 (event clock) (1us) // timeout
    {0x3912, 0xE7}, // to_scnt1_low					// timeout
    {0x3913, 0x03}, // to_scnt1_high (1ms)          // timeout (manual 84p)
    {0x3914, 0x01}, // to_mcnt      				// timeout
    {0x3916, 0x40}, // pkt_gap_low
    {0x3917, 0x00}, // pkt_gap_high
    ...
    {0x320C, 0x1F}, // [6] : DTAG_FREE_RUN_MODE_r, [5] : DTAG_MASK_FIRST_FRAME_r, [1] : DTAG_GRST_MODE_r, [0] : DTAG_GH_MODE_r
    {0x321D, 0x00}, // DTAG_FRM_MAGRIN_r_MSB
    {0x321E, 0x02}, // DTAG_FRM_MAGRIN_r_LSB : 1LSB x 2^12 x Event Clock period
                    // Scan Time             : # of Column x 92 x Evect Clock period
                    // Margin                : 254 x Event Clock Period
                    //        {0x321E, 0x0f},
...
// 		//////////////        CROP Setting         ///////////////////////
// 		//////////////////////////////////////////////////////////////////
// 		{0x3300, 0x00}, // CROP_BYPASS_r
// 		{0x3301, 0x2D}, // CROP_Y_GROUP_START_r
// 		{0x3302, 0xFF}, // CROP_Y_START_MASK_r
// 		{0x3303, 0x59}, // CROP_Y_GROUP_END_r
// 		{0x3304, 0xFF}, // CROP_Y_END_MASK_r
// 		{0x3305, 0x01}, // CROP_START_X_r_MSB
// 		{0x3306, 0xE0}, // CROP_START_X_r_LSB
// 		{0x3307, 0x03}, // CROP_END_X_r_MSB
// 		{0x3308, 0xBF}, // CROP_END_X_r_LSB
// 		{0x3309, 0x00}, // CROP_FRAME_SKIP_ENABLE_r
// 		{0x330A, 0x01}, // CROP_FRAME_REPEAT_NUM_r
...
const int length_DVS_regs_1958fps = ARRAY_SIZE(DVS_regs_1958fps);
const int length_DVS_regs_3287fps = ARRAY_SIZE(DVS_regs_3287fps);
const int length_DVS_regs_modified = ARRAY_SIZE(DVS_regs_modified);
