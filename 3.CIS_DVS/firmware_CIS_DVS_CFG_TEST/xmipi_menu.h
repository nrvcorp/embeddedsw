...
// TODO: Read from hardware status register
#define MAX_THRESHOLD 845 //13*13*5
...
#endif
#if(ENABLE_DVS_RESET)
	XMIPI_DVS_RESET_MENU,
#endif
	XMIPI_RESET_DEBUG_MENU,
	XMIPI_DVS_READ_REG_MENU,
	//XMIPI_DVS_WRITE_REG_MENU,
	XMIPI_NUM_MENUS
} XMipi_MenuType;
