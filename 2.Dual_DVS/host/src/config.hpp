...
#define DVS_FRAME_BASEADDR (DDR_BASEADDR + 0x20000000)

#define DVS_FRAME_RDY_BASEADDR_1 (DDR_BASEADDR + 0x3000000)
#define DVS_FRAME_BASEADDR_1 (DDR_BASEADDR + 0x30000000)
/******************* DISPLAY Setting ******************************/
#define DVS_FPS 2000
...
#define H2C_DEVICE_DVS_1 "/dev/xdma_dvs0_h2c_1"
#define C2H_DEVICE_DVS_1 "/dev/xdma_dvs0_c2h_1"
