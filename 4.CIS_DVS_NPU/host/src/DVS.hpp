...
public:
    ...
    */
    DVS(
        ...
        MutexManager &display_mutex, bool double_buffering = false);
   /**
    ...
    */
    void crop_coord(int img_show = 1, int is_update = 0, bool is_flip = false);
    /**
    ...
    * @param is_flip if the DVS image is flipped using a mirror.
    */
    void crop_new_ROI(int img_show = 1, int is_update = 0, bool is_flip = false);
    ~DVS();
};
